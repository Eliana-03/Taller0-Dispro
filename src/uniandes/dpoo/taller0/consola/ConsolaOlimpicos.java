...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					System.out.println("llego a la opcion 13");
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consular el pa�s que representa un atleta.");
	...
	private void ejecutarPaisPorAtleta()
	{
		...
		if (pais == null) 
		{
			System.out.println("\n" + " No se encontró el país para el atleta " + atleta);
		} 
		else 
		{			
			System.out.println("\n" + " El país el cual representa el atleta " + atleta + " es " + pais.darNombre());	
		}
